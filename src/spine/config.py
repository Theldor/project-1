...
def normalize_config(config):
    ...
    overlay_cfg["alert_chime_command"] = str(overlay_cfg.get("alert_chime_command", ""))
    overlay_cfg["alert_chime_sound"] = str(overlay_cfg.get("alert_chime_sound", "Glass"))
